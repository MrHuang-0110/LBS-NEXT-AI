...
#endif
#ifndef PIKA_MODULE__BEEP_DISABLE
    obj_newObj(self, "_beep", "_beep", New__beep);
#endif
...
#ifndef PIKA_MODULE__BEEP_DISABLE
void _beep_play_muicMethod(PikaObj *self, Args *_args_){
    char* feq = args_getStr(_args_, "feq");
    pika_float ms = args_getFloat(_args_, "ms");
    _beep_play_muic(self, feq, ms);
}
method_typedef(
    _beep_play_muic,
    "play_muic", "feq,ms"
...
class_def(_beep){
    __BEFORE_MOETHOD_DEF
    method_def(_beep_play_muic, 1616502792),
};
class_inhert(_beep, TinyObj);

PikaObj *New__beep(Args *args){
    PikaObj *self = New_TinyObj(args);
    obj_setClass(self, _beep);
    return self;
}
#endif
...
void _color_lux_stateMethod(PikaObj *self, Args *_args_){
    int port = args_getInt(_args_, "port");
    pika_float res = _color_lux_state(self, port);
    method_returnFloat(_args_, res);
}
method_typedef(
    _color_lux_state,
...
void _color_one_calibrateMethod(PikaObj *self, Args *_args_){
    int port = args_getInt(_args_, "port");
    int timers = args_getInt(_args_, "timers");
    _color_one_calibrate(self, port, timers);
}
method_typedef(
    _color_one_calibrate,
    "one_calibrate", "port,timers"
);

void _color_set_color_threshold_valueMethod(PikaObj *self, Args *_args_){
    int port = args_getInt(_args_, "port");
    int value = args_getInt(_args_, "value");
    _color_set_color_threshold_value(self, port, value);
}
method_typedef(
    _color_set_color_threshold_value,
    "set_color_threshold_value", "port,value"
);

void _color_two_calibrateMethod(PikaObj *self, Args *_args_){
    int port1 = args_getInt(_args_, "port1");
    int port2 = args_getInt(_args_, "port2");
    int timers = args_getInt(_args_, "timers");
    _color_two_calibrate(self, port1, port2, timers);
}
method_typedef(
    _color_two_calibrate,
    "two_calibrate", "port1,port2,timers"
);

class_def(_color){
    __BEFORE_MOETHOD_DEF
    method_def(_color_one_calibrate, 67119693),
    method_def(_color_set_color_threshold_value, 109064823),
    method_def(_color_lux, 193498590),
    method_def(_color_lux_state, 201021950),
    method_def(_color_cmp_lux, 1323832317),
    method_def(_color_two_calibrate, 2131277509),
};
...
void _key_key_mastMethod(PikaObj *self, Args *_args_){
    ...
    int res = _key_key_mast(self, keyname, State);
    method_returnInt(_args_, res);
}
method_typedef(
    _key_key_mast,
...
void _key_key_remoteMethod(PikaObj *self, Args *_args_){
    ...
    int res = _key_key_remote(self, keys, coor);
    method_returnInt(_args_, res);
}
method_typedef(
    _key_key_remote,
...
void _key_read_adcance_left_offsetMethod(PikaObj *self, Args *_args_){
    int res = _key_read_adcance_left_offset(self);
    method_returnInt(_args_, res);
}
method_typedef(
    _key_read_adcance_left_offset,
    "read_adcance_left_offset", ""
);

void _key_read_advance_right_offsetMethod(PikaObj *self, Args *_args_){
    int res = _key_read_advance_right_offset(self);
    method_returnInt(_args_, res);
}
method_typedef(
    _key_read_advance_right_offset,
    "read_advance_right_offset", ""
);

void _key_read_retreat_left_offsetMethod(PikaObj *self, Args *_args_){
    int res = _key_read_retreat_left_offset(self);
    method_returnInt(_args_, res);
}
method_typedef(
    _key_read_retreat_left_offset,
    "read_retreat_left_offset", ""
);

void _key_read_retreat_right_offsetMethod(PikaObj *self, Args *_args_){
    int res = _key_read_retreat_right_offset(self);
    method_returnInt(_args_, res);
}
method_typedef(
    _key_read_retreat_right_offset,
...
class_def(_key){
    ...
    method_def(_key_read_adcance_left_offset, 1146573551),
    method_def(_key_read_retreat_right_offset, 1393761626),
    method_def(_key_read_advance_right_offset, 1794946261),
    method_def(_key_read_retreat_left_offset, 1937507559),
};
...
void _math_roundMethod(PikaObj *self, Args *_args_){
    pika_float v = args_getFloat(_args_, "v");
    pika_float res = _math_round(self, v);
    method_returnFloat(_args_, res);
}
method_typedef(
    _math_round,
...
class_def(_math){
    ...
    method_def(_math_round, 273467373),
...
void _matrix_showMethod(PikaObj *self, Args *_args_){
    ...
    _matrix_show(self, bufer1, bufer2, bufer3, bufer4, bufer5, bufer6, bufer7);
}
method_typedef(
    _matrix_show,
    "show", "bufer1,bufer2,bufer3,bufer4,bufer5,bufer6,bufer7"
);
...
#ifndef PIKA_MODULE__MOTOR_DISABLE
void _motor_mov_dir_powerMethod(PikaObj *self, Args *_args_){
    char* dir = args_getStr(_args_, "dir");
    pika_float duty = args_getFloat(_args_, "duty");
    _motor_mov_dir_power(self, dir, duty);
}
method_typedef(
    _motor_mov_dir_power,
    "mov_dir_power", "dir,duty"
);

void _motor_mov_dir_power_secondsMethod(PikaObj *self, Args *_args_){
    char* dir = args_getStr(_args_, "dir");
    pika_float duty = args_getFloat(_args_, "duty");
    pika_float degrees = args_getFloat(_args_, "degrees");
    _motor_mov_dir_power_seconds(self, dir, duty, degrees);
}
method_typedef(
    _motor_mov_dir_power_seconds,
    "mov_dir_power_seconds", "dir,duty,degrees"
);
...
void _motor_mov_find_line_runMethod(PikaObj *self, Args *_args_){
    pika_float gray_left = args_getFloat(_args_, "gray_left");
    pika_float gray_right = args_getFloat(_args_, "gray_right");
    ...
    _motor_mov_find_line_run(self, gray_left, gray_right, power1, power2, kp, kd);
}
method_typedef(
    _motor_mov_find_line_run,
    "mov_find_line_run", "gray_left,gray_right,power1,power2,kp,kd"
);

void _motor_mov_for_power_secondsMethod(PikaObj *self, Args *_args_){
    pika_float duty1 = args_getFloat(_args_, "duty1");
    pika_float duty2 = args_getFloat(_args_, "duty2");
    pika_float degrees = args_getFloat(_args_, "degrees");
    _motor_mov_for_power_seconds(self, duty1, duty2, degrees);
}
method_typedef(
    _motor_mov_for_power_seconds,
    "mov_for_power_seconds", "duty1,duty2,degrees"
);

void _motor_mov_powerMethod(PikaObj *self, Args *_args_){
    pika_float duty1 = args_getFloat(_args_, "duty1");
    pika_float duty2 = args_getFloat(_args_, "duty2");
    _motor_mov_power(self, duty1, duty2);
}
method_typedef(
    _motor_mov_power,
    "mov_power", "duty1,duty2"
);

void _motor_mov_set_advance_offsetMethod(PikaObj *self, Args *_args_){
    int offset1 = args_getInt(_args_, "offset1");
    int offset2 = args_getInt(_args_, "offset2");
    _motor_mov_set_advance_offset(self, offset1, offset2);
}
method_typedef(
    _motor_mov_set_advance_offset,
    "mov_set_advance_offset", "offset1,offset2"
);

void _motor_mov_set_retreat_offsetMethod(PikaObj *self, Args *_args_){
    int offset1 = args_getInt(_args_, "offset1");
    int offset2 = args_getInt(_args_, "offset2");
    _motor_mov_set_retreat_offset(self, offset1, offset2);
}
method_typedef(
    _motor_mov_set_retreat_offset,
    "mov_set_retreat_offset", "offset1,offset2"
);

void _motor_mov_set_stop_moduleMethod(PikaObj *self, Args *_args_){
    int mode = args_getInt(_args_, "mode");
    _motor_mov_set_stop_module(self, mode);
}
method_typedef(
    _motor_mov_set_stop_module,
    "mov_set_stop_module", "mode"
);
...
void _motor_pairMethod(PikaObj *self, Args *_args_){
    ...
    _motor_pair(self, port1, port2, state);
}
method_typedef(
    _motor_pair,
    "pair", "port1,port2,state"
);

void _motor_run_for_power_secondsMethod(PikaObj *self, Args *_args_){
    int port = args_getInt(_args_, "port");
    pika_float duty = args_getFloat(_args_, "duty");
    pika_float degrees = args_getFloat(_args_, "degrees");
    _motor_run_for_power_seconds(self, port, duty, degrees);
}
method_typedef(
    _motor_run_for_power_seconds,
    "run_for_power_seconds", "port,duty,degrees"
);

void _motor_run_powerMethod(PikaObj *self, Args *_args_){
    int port = args_getInt(_args_, "port");
    pika_float duty = args_getFloat(_args_, "duty");
    _motor_run_power(self, port, duty);
}
method_typedef(
    _motor_run_power,
    "run_power", "port,duty"
...
void _motor_stop_moduleMethod(PikaObj *self, Args *_args_){
    ...
    _motor_stop_module(self, port, stop);
}
method_typedef(
    _motor_stop_module,
    "stop_module", "port,stop"
);
...
class_def(_motor){
    ...
    method_def(_motor_mov_set_advance_offset, 742862105),
    method_def(_motor_mov_set_retreat_offset, 783209950),
    method_def(_motor_run_for_power_seconds, 976274906),
    method_def(_motor_run_power, 1155986630),
    method_def(_motor_mov_power, 1556064387),
    method_def(_motor_mov_for_power_seconds, 1658322199),
    method_def(_motor_mov_dir_power_seconds, 1944409551),
    method_def(_motor_pair, 2090607761),
    method_def(_motor_stop, 2090736459),
    method_def(_motor_mov_find_line_init, 2120637489),
    method_def(_motor_mov_dir_power, 2137946593),
};
...
#ifndef PIKA_MODULE__OS_DISABLE
void _os_get_port_linkeMethod(PikaObj *self, Args *_args_){
    int port = args_getInt(_args_, "port");
    int res = _os_get_port_linke(self, port);
    method_returnInt(_args_, res);
}
method_typedef(
    _os_get_port_linke,
...
void _os_stop_exitMethod(PikaObj *self, Args *_args_){
    _os_stop_exit(self);
}
method_typedef(
    _os_stop_exit,
